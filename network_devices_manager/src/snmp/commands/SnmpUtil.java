...
public class SnmpUtil {
	...
	public static CommunityTarget createDefault(String ip, String community) {
		return createTarget(GenericAddress.parse(DEFAULT_PROTOCOL + ":" + ip 
				+ "/" + DEFAULT_PORT), community, DEFAULT_VERSION,DEFAULT_TIMEOUT, DEFAULT_RETRY);
	}
	...
	public static CommunityTarget createDefault(String ip, String port, String community) {
		return createTarget(GenericAddress.parse(DEFAULT_PROTOCOL + ":" + ip + "/" + port),
