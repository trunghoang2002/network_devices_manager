...
public class database {
    ...
    public static void check_tables(){
     try {
        ...
        sql[1]  =   "CREATE TABLE IF NOT EXISTS "+database_name+"."+tablename_interfaces+"(" +
...
//end
    ...
    public static ArrayList<String[]> get_port_dscr(String ip){
        ...
        String sql = "select distinct R.port,D.user_description,D.snmp_description from "
                +database_name+"."+tablename_records+" R INNER JOIN "+database_name+"."+tablename_interfaces+" D ON R.ip=D.device_ip and R.port=D.device_port "
                + where_ip;
        ResultSet rs = stmt.executeQuery(sql);
...
public static ArrayList<gui_model_device_status> get_device_status_data(String sql){
    ...
    public static void add_device(gui_model_device d){
        try {
            ...
            String sql="INSERT INTO  "+database_name+"."+tablename_interfaces+" (device_ip,device_port,community,device_speed,user_description,snmp_description) VALUES('"+ip+"',"+
    ...
    public static void add_device_status(gui_model_device_status d){
        try {
            create_connection();
            stmt = conn.createStatement();
    ...
    public static void remove_device(gui_model_device d){
        ...
        stmt = conn.createStatement();
            ...
            int port  = d.getPort();
                   //rs.getInt("port");
            String sql = "delete from "+database_name+"."+tablename_interfaces+" where device_ip='"+ip+"' and device_port="+port+";";
    ...
    public static void remove_device_status(gui_model_device_status d){
        ...
        stmt = conn.createStatement();
            ...
            String ip = d.getIp();
            String sql = "delete from "+database_name+"."+tablename_devices+" where device_ip='"+ip+"';";
